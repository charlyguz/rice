...
---- WORKSPACES & MONITORS ----
-------------------------------
-- SUPER + número: cambiar al workspace 1-10
-- SUPER + SHIFT + número: mover la ventana al workspace 1-10 y seguirla

for i = 1, 10 do
    local key = i % 10 -- El workspace 10 utiliza la tecla 0
...
-- SUPER + ALT + flecha: cambiar el foco al otro monitor
...
-- SUPER + ALT + SHIFT + flecha:
-- mover la ventana al otro monitor y seguirla

hl.bind(
    mainMod .. " + ALT + SHIFT + Left",
    hl.dsp.window.move({
        monitor = "-1",
        follow = true,
    })
